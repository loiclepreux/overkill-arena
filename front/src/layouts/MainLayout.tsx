            ...
            <header className="border-b border-zinc-800 bg-black">
                <div className="mx-auto flex w-full max-w-[1700px] flex-col gap-5 px-4 py-5 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center">
                        {/* LOGO */}
                        <div className="relative sm:-ml-6 flex h-30 w-30 items-center justify-center">
                            <div className="absolute inset-0 rounded-full bg-red-600/20 blur-2xl" />
                            <img
                                src={logo}
                                alt="Overkill Arena Logo"
                                className="relative h-full w-full object-contain drop-shadow-[0_0_15px_rgba(255,0,0,0.45)]"
                            />
                        </div>

                        {/* TEXT */}
                        <div>
                            <h1 className="text-2xl sm:text-4xl font-black uppercase tracking-[0.18em]">
                    ...
                    <nav className="flex w-full justify-center gap-3 text-sm font-medium sm:w-auto sm:justify-end">
                        {isAuthenticated ? (
                            <>
                                ...
                                <span className="text-zinc-400">{user?.pseudo}</span>
