...
import { UpdateTournamentDto, UpdateTournamentStatusDto } from './dto/update-tournament.dto';
...
export class TournamentsController {
  ...
  @UseGuards(JwtGuard, RolesGuard)
  @Roles('ADMIN')
  updateStatus(@Param('id') id: string, @Body() body: UpdateTournamentStatusDto) {
  ...
  @Delete(':id/register')
  @UseGuards(JwtGuard)
  unregister(@Param('id') tournamentId: string, @Body('teamId') teamId: string) {
