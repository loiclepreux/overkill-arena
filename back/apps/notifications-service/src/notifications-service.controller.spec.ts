...
describe('NotificationsServiceController', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        { provide: NotificationsServiceService, useValue: mockService },
      ],
    }).compile();

    controller = module.get<NotificationsServiceController>(
  ...
  it('forwards getByUser to service', () => {
    ...
    void controller.getByUser({ userId: 'uid', page: 1, limit: 20 });
  ...
  it('forwards getUnreadCount to service', () => {
    ...
    void controller.getUnreadCount({ userId: 'uid' });
  ...
  it('forwards markAllRead to service', () => {
    ...
    void controller.markAllRead({ userId: 'uid' });
